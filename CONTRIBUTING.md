...
posted to #flurbo-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The Flurbo Project.
...
The "Flurbo Maintainer Team" is defined in this document as the following users:
- fluffypony
- flurbomooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Flurbo code or Flurbo's dependency code or Flurbo's potential/future dependency code or research which successfully implements Flurbo.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Flurbo Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Flurbo Maintainer Team.
